const textConfig = {
  ...
  text5: "Nằm mơ à???",
  text6: "Em đồng ý <3",
  text7: "Vì sao em muốn giải cứu hoàng tử :vvvv",
  text8: "Gửi đến hoàng tử <3",
  text9: "Vì cậu đẹp try vlllll",
  text10: "Chà chà người đẹp thật tinh tế ^^\n Đúng là công chúa của ta =))))",
  text11:
    "Dưới đây là cách để giải lời nguyền cho hoàng tử. Hãy nhanh tay đến giải cứu chàng đi nàoooo!",
  text12: "Let's gooo <3",
};
